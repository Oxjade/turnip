...
pip3 install flask flask-cors gunicorn python-dotenv psutil sendgrid requests siwe eth-account paramiko resend --break-system-packages --ignore-installed -q
